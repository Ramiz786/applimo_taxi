            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" style="margin: 0px; text-align: center; box-sizing: border-box;padding: 20px;background-color: #f5b21d;">
                        <p style="margin: 0;padding: 0;font-family: 'Poppins', sans-serif;font-weight: 400;font-size: 18px;color: #fff;"><img src="<?php echo BASE_URL ?>assets/img/logo-dark.png" style="display: block;width: 150px;margin: 0 auto;height: 100px;">You have recevied contact request.</p>
                    </td>
                </tr>
                                        ...
                                        <table style="width: 100%; padding: 0; text-align: left; border: none; border-collapse: collapse;" cellspacing="0" cellpadding="0">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="font-weight: 400;color: #000;font-size: 15px;padding-bottom: 5px;"><?php echo $post_data['FirstName'] . ' ' . $post_data['LastName']  ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th style="font-weight: 700;color: #000;font-size: 15px;padding-bottom: 5px;">Message</th>
                                                    <td style="font-weight: 400;color: #000;font-size: 15px;padding-bottom: 5px;"><?php echo $post_data['Message'] ?></td>
                                                </tr>
