            ...
            <tbody>
                ...
                <tr>
                    <td colspan="2" style="padding: 40px 15px; margin: 0px; text-align: center;">
                        <img src="<?php echo BASE_URL ?>assets/img/logo-dark.png" style="display: block;width: 250px;margin: 0 auto;height: 197px;">
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style="margin: 0px; text-align: center; box-sizing: border-box;padding: 20px;background-color: #f5b21d;">
                        <p style="margin: 0;padding: 0;font-family: 'Poppins', sans-serif;font-weight: 400;font-size: 18px;color: #fff;">You have recevied inquiry for taxi booking <?php echo (isset($post_data) && $post_data->Type != '') ? $post_data->Type : '' ?></p>
                    </td>
                </tr>
                    ...
                    <td style="width: 50%;padding: 15px;">
                        <div class="address">
                            <p style="font-size: 16px;color: #000;font-family: 'Poppins', sans-serif;font-weight: 400;margin: 0;padding: 0;"><?php echo WEBSITE_NAME; ?> <br>
                                <i style="font-size: 15px;color: #2d2d2d;font-family: 'Poppins', sans-serif;font-weight: 400;">Gallerist.</i> <br>
